...
Martview.Application = function (params) {
    ...
    // private methods
    var changeDataset = function (menu_item) {
    ...
    conn.request({
        ...
        success: function (response) {
            ...
            // add changeDataset handler to each dataset menu item
            changeform.menu.items.each(function (mart) {
                mart.menu.items.each(function (dataset) {
                    dataset.menu.on('itemclick', changeDataset);
                });
            });
        },
        failure: function () {
